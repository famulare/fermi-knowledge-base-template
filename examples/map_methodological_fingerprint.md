...
```
Situational Awareness --enables--> Good Decision-Making
  Rationale: Understanding what has happened preserves human agency;
  prediction can remove it

Hidden Correlations --require--> Night Science Thinking
  Rationale: Detecting unmeasured correlations requires speculative
  connection-making across disciplines

Night Science --enables--> Scientific Integrity
  Rationale: Willingness to speculate about alternatives enables
  recognizing when models don't fit

Scientific Integrity --enables--> Discovery
  Rationale: Refusing to ignore discrepancies allows truth to emerge
  despite aesthetic preferences

"Nothing Is One Thing" --motivates--> Multi-Scale Thinking
  Rationale: If everything is connected, understanding requires
  looking across scales and domains
```
...
- Evidence: Immunity claims, Night Science post, NAb titer as continuous scale, birth/death ambiguity reflection
...
- Evidence: 5% problem, hidden correlations

### 5. Closed-Loop Control Framing
Think about interventions as part of feedback systems, not one-shot actions.
- Evidence: Fit-for-purpose taxonomy

### 6. Honest About Limitations
Acknowledge model limitations, human weakness for aesthetics, structural constraints.
- Evidence: Kepler post, acknowledgment of arrogance concern

### 7. Scale-Crossing Connections
Actively look for links between micro and macro, technical and policy.
- Evidence: Stated principle in CLAUDE.md, evident in blog posts

### 8. Reality's Surprising Detail
Details matter, but which ones depends on context; investigate structures.
- Evidence: Salvatier reference, blog philosophy
...
1. **How do these methodological commitments manifest in specific research outputs?**
   - Now traced: NAb series shows Night Science → mechanistic insight; COVID gray literature shows situational awareness in practice

2. **Are there tensions between these commitments?**
   - Apparent tension: Night Science speculation vs Kepler-standard data attention
   - Resolution: Both are necessary; speculation generates alternatives, data attention tests them
...
- Personal COVID analysis project
- Personal/reflective posts (6 posts → values map)
...
- **Last updated:** 2026-01-23
- **Change log:**
  - 2026-01-23: Created as draft from Phase 1 methodological blog posts
  - 2026-01-23: Completed with integration from all 7 phases of blog repository ingest
